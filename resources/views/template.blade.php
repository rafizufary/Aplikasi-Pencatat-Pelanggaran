				...
				<ul class="side-menu">
					...
					<li>
						<a href="/siswa" class="nav-link {{ ($title === "Siswa") ? 'active' : ''	}}">
							<i class='bx bxs-user icon'></i> Siswa
						</a>
					</li>
					<li>
						<a href="/mapel" class="nav-link {{ ($title === "Mata Pelajaran") ? 'active' : ''	}}">
							<i class='bx bxs-book icon'></i> Mata Pelajaran
						</a>
					</li>
					<li>
						<a href="/nilai" class="nav-link {{ ($title === "Nilai") ? 'active' : ''	}}">
	...
	<footer>
		<div class="footer">
			<div class="float-start">
				<p>2022 &copy; Raport</p>
			</div>
			<div class="float-end">
				<p>Crafted with
					<span class="text-danger">
						<i class="fa fa-heart"></i> by
						<a href="https://www.facebook.com/" class="author-footer">Me</a>
					</span>
				</p>
			</div>
		</div>
